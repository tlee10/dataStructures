...
if __name__ == "__main__":
    ...
    # bt.delete(bt.root, 779)
    # bt.delete(bt.root, 932)
    # bt.delete(bt.root, 924)
    # bt.delete(bt.root, 540)
    # bt.delete(bt.root, 417)
    # bt.delete(bt.root, 736)
    # bt.delete(bt.root, 200)
    # bt.delete(bt.root, 132)
    # bt.delete(bt.root, 933)
    # bt.delete(bt.root, 51)
    # bt.delete(bt.root, 271)
    # bt.delete(bt.root, 539)
    # bt.delete(bt.root, 65)
    # print(bt.search(bt.root, 65))
